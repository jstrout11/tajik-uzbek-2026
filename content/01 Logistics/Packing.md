...
## Tech
- [ ] Phone + cable + brick charger
- [ ] 10000mAh power bank each
- [ ] Universal adapter (Type C/F European in both countries)
- [ ] **Garmin inReach Mini 2** with active subscription — see [[SIM & Connectivity]]
- [ ] Camera (if bringing) + spare batteries + storage cards
